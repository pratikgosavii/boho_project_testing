...
def books_eng_filter(request):
    ...
    if year == 'all' and field != 'all':
       posts = books.objects.filter(year = 'all', pattern =  filter_field, category = category)

    elif year != 'all' and field == 'all':
        posts = books.objects.filter(year = filter_year, pattern =  'all', category = category)

    elif year == 'all' and field == 'all':
        posts = books.objects.filter(year = 'all', pattern =  'all', category = category)

    else:
        posts = books.objects.filter(year = filter_year, pattern = filter_field, category = category)
