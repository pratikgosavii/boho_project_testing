...
urlpatterns = [
    ...
    path('remove_cartbook_byid', views.remove_cartbook_byid, name='remove_cartbook_byid'),
    path('remove_wishlistbook_byid', views.remove_wishlistbook_byid, name='remove_wishlistbook_byid'),
